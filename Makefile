...
kubectl-prometheus: # 2) install prometheus
	./make.sh kubectl-prometheus

kubectl-ebs-csi-driver: # 2) install ebs-csi-driver
	./make.sh kubectl-ebs-csi-driver

kubectl-grafana: # 2) install grafana
	./make.sh kubectl-grafana
